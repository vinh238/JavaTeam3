...
public class Rocket {
    public Rocket(){
        ...
        //tạo đối tượng hình dạng đường dẫn 2d
    ...
    //tạo lớp lưu trữ hình dạng của tên lửa
    private final Area rocketShap;
    //cập nhật phương thức thay đổi vị trí và các lớp tên lửa
    ...
    //dùng đồ họa 2d
    //AffineTransform là Phép co dãn thực hiện phóng to hoặc thu nhỏ đối tượng 
    ...
    //tạo phương thức shape trả về hình dạng và vị trí thực của x và y
    ...
    //tạo phương thức kiểm tra tên lửa ra ngoài màn hình
